...
#define NETWORKS_PATH "/home/guilherme/scheduling/guilherme/enumerating/testing/networks/"
...
int main(int argc, char** argv)
{
	...
	try
	{
		...
		{
			objective += vars[j];
			infile.read((char*)&msb, sizeof(uint128_t));
			infile.read((char*)&lsb, sizeof(uint128_t));
			p.set_msb(msb);
			p.set_lsb(lsb);
